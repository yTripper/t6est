...
INSTALLED_APPS = [
    ...
    'cyberpolygonAPI.apps.CyberpolygonapiConfig',
    'cyberpolygonVM.apps.CyberpolygonvmConfig',
    'cyberpolygonAuth.apps.CyberpolygonauthConfig',
    'cyberpolygonTests.apps.CyberpolygontestsConfig',
    # ----------------------------
...
ASGI_APPLICATION = 'cyberpolygonApp.asgipi.application'
